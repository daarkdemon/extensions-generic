...
import { HunlightScans } from '../HunlightScans/HunlightScans'
import chai from 'chai'
import chaiAsPromised from 'chai-as-promised'

describe('HunlightScans Tests', () => {

    const wrapper: APIWrapper = new APIWrapper()
    const source: Source = new HunlightScans(cheerio)
     ...
     */
    const mangaId = '755149-moshin-hunter'
