...
import { TheNonameScans } from '../TheNonameScans/TheNonameScans'
import chai from 'chai'
import chaiAsPromised from 'chai-as-promised'

describe('TheNonameScans Tests', () => {

    const wrapper: APIWrapper = new APIWrapper()
    const source: Source = new TheNonameScans(cheerio)
     ...
     */
    const mangaId = '109230-child-of-light'
    it('Retrieve Manga Details', async () => {
        ...
        expect(data.author, 'Missing Author').to.be.exist
