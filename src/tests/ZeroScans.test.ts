...
import { ZeroScans } from '../ZeroScans/ZeroScans'
import chai from 'chai'
import chaiAsPromised from 'chai-as-promised'

describe('ZeroScans Tests', () => {

    const wrapper: APIWrapper = new APIWrapper()
    const source: Source = new ZeroScans(cheerio)
     ...
     */
    const mangaId = '119028-star-martial-god-technique'
