...
const IMMORTALUPDATES_DOMAIN = 'https://immortalupdates.com';
exports.ImmortalUpdatesInfo = {
    version: Madara_1.getExportVersion('0.0.0'),
    name: 'ImmortalUpdates',
    description: 'Extension that pulls manga from ImmortalUpdates.com',
    author: 'darkdemon',
    authorWebsite: 'http://github.com/daarkdemon',
    icon: 'icon.png',
    contentRating: paperback_extensions_common_1.ContentRating.EVERYONE,
    websiteBaseURL: IMMORTALUPDATES_DOMAIN,
    sourceTags: [
        {
            text: 'Notifications',
...
class ImmortalUpdates extends Madara_1.Madara {
    constructor() {
        super(...arguments);
        this.baseUrl = IMMORTALUPDATES_DOMAIN;
...
class Parser {
    ...
    parseChapterList($, mangaId, source) {
        ...
        for (const obj of $('li.wp-manga-chapter  ').toArray()) {
            ...
            const chapNum = Number((_b = (_a = id.match(/\D*(\d*\-?\d*)\D*$/)) === null || _a === void 0 ? void 0 : _a.pop()) === null || _b === void 0 ? void 0 : _b.replace(/-/g, '.'));
